package com.allaboutscala.chapter.four.eight.typealias

/*
 we will learn how to define and use type aliasing to create shortcuts to other types or functions.

 Type aliasing can be useful to help you provide more meaningful names which represent your business
 or domain objects without having to create unnecessary types.
...
object TypeAliasing extends App {
  ...
  // we are aliasing the Tuple2 type and giving it a more meaningful name of CartItem which is essentially
  // a pair of Donut item with the quantity being bought.
  ...
  // If however you need to be even more precise about your shopping cart items, you might as well
  // create another case class instead of using type aliasing of Tuple2.
