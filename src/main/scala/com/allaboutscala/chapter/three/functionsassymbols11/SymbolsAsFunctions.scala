package com.allaboutscala.chapter.three.functionsassymbols11

object SymbolsAsFunctions extends App {
  ...
  println(s"Calling function - = ${donutCostCalculator.-(10.25)}")

  println("\nStep 5: How to call a function using the operator style notation")
  println(s"Calling function - with operator style notation = ${donutCostCalculator - 10.75}")

  println("\nStep 5: How to call a function using the operator style notation")
  println(s"Calling function - with operator style notation = ${donutCostCalculator +++ 5}")
